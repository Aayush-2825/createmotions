      ...
      <div className="mx-auto max-w-7xl space-y-12 px-4 pb-20 pt-10 sm:px-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    ...
                    {user.role === "ADMIN" && (
                      <Badge
                        variant="outline"
                        className="border-purple-500/30 bg-purple-500/10 text-purple-400 gap-1"
                      >
        ...
        <section className="grid gap-6 md:grid-cols-3">
          ...
          <MetricCard
            ...
            value={
              user.role === "ADMIN"
                ? user.stats.resourcesCreatedCount
                : resources.length
            }
            icon={Activity}
            color="text-pink-400"
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            <div className="space-y-2 max-w-lg">
              ...
              <p className="text-neutral-400">
                Invite friends and earn coins when they join. Build your network
                and get rewarded.
              </p>
            </div>
